...
def export():
    ...
    if c.stroke:
        styling1 += "<s>"
        styling2 = "</s>"+styling2
    to_export = SCHABL.format(c.color, c.color, title, styling1, content, styling2, id_, id_, id_, id_, id_, id_)
...
c.create_text(325, 840, text="Copyright Leander Kafemann 2024-2025  -  Version 4.0.3", font=("Verdana", "10"))
